...
public class LoginPage implements InterfaceServiceCall {
    ...
    private CommonComboBoxField cmpCode = new CommonComboBoxField("sys.Sys00_Common.selectCmpCombo");
	...
	public void open() {
		...
		HTML image = new HTML("<center><div><img src='img/FAMS.png' width='423'></center></div>"); 
...
//		loginId.setText("ADMIN");
	...
	public void login(){
		...
		request.putStringParam("cmpCode", cmpCode.getCode());
