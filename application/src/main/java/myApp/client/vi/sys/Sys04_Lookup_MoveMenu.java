...
public class Sys04_Lookup_MoveMenu extends Window implements InterfaceServiceCall {
	...
	private TreeGrid<Sys04_CmpMenuModel> treeGrid ; 
	private Sys04_CmpMenuModel menuModel, deleteModel; 
	private Tree<Sys04_CmpMenuModel, String> menuTree ; 
	
	private TreeStore<Sys04_CmpMenuModel> treeStore = new TreeStore<Sys04_CmpMenuModel>(new ModelKeyProvider<Sys04_CmpMenuModel> () {
		@Override
	...
	private ValueProvider<Sys04_CmpMenuModel, String> treeValueProvider = new ValueProvider<Sys04_CmpMenuModel, String>() {
		
		@Override
		public String getValue(Sys04_CmpMenuModel menu) {
			return menu.getMenuName();
		}
		
		@Override
		public void setValue(Sys04_CmpMenuModel menu, String value) {
		}
	...
	private Tree<Sys04_CmpMenuModel, String> getMenuTree(){

		Tree<Sys04_CmpMenuModel, String> tree = new Tree<Sys04_CmpMenuModel, String>(treeStore, treeValueProvider) {
			...
			protected boolean hasChildren(Sys04_CmpMenuModel model) {
	...
	public void open(TreeGrid<Sys04_CmpMenuModel> treeGrid, Sys04_CmpMenuModel menuModel) {
		...
		request.addParam("cmpCode", menuModel.getCmpCode());
	...
	private void moveTree() {
		...
		Sys04_CmpMenuModel targetModel = menuTree.getSelectionModel().getSelectedItem() ; 
		
		if(targetModel != null) {
			menuModel.setPrntId(targetModel.getCmpMenuId()); // parent Id를 변경한다. 	

			TreeGridUpdate<Sys04_CmpMenuModel> service = new TreeGridUpdate<Sys04_CmpMenuModel>(); 
			service.update(this.treeGrid.getTreeStore(), menuModel, "sys.Sys04_CmpMenu.update", new InterfaceCallbackResult() {
				@Override
				public void execute(Object result) {
					
					// 이전 tree에서 삭제하고 
					Sys04_CmpMenuModel parentModel = treeGrid.getTreeStore().getParent(deleteModel);
