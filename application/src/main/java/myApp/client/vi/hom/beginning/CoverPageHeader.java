...
//		BorderLayoutData northLayoutData = new BorderLayoutData(10);
		HTML image = new HTML("<center><div> <img src='img/FAMSVisual.gif' style='border-bottom: 1px solid orange; ' width='"+ WIDTH +"' height='"+ HEIGHT +"'></div>");
//		HTML image = new HTML("<center><div> <img src='img/FAMSVisual.gif' width='"+ WIDTH +"' height='"+ HEIGHT +"'></div>");
